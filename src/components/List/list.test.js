...
describe("When everything is ok", () => {
  test("Should name appear on the list when the user types a value on input and click the button", async () => {
    render(<List />);
  ...
  it("Should button be available when the input is typed", () => {
    render(<List />);
